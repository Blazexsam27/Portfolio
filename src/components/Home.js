  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="bottomContainer1">
            <p id="about">
              ...
              <br />
              I have completed my Higher secondary education from Kendriya Vidyalaya (CSBE Board) No.3 Baroda, Gujarat,
              and right now pursuing career as a Software Engineer.
      ...
      <section>
            ...
            <div className="bottomContainer1">
            <br />
              <p>Level 3 Coder at codechef. <br />
              ...
              learning and ssd_mobile_net. <br /></p>
              <br/><br/>
            </div>
